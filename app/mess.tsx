...
export default function MessScreen() {
  return (
    <View style={s.container} accessibilityLabel="Mess screen">
      <Ionicons name="restaurant-outline" size={48} color={C.muted} accessibilityElementsHidden />
      <Text style={s.title}>Mess</Text>
